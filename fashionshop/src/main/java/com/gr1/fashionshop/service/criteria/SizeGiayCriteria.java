...
/**
 * Criteria class for the {@link com.gr1.fashionshop.domain.SizeGiay} entity. This class is used
 * in {@link com.gr1.fashionshop.controller.SizeGiayResource} to receive all the possible filtering options from
...
public class SizeGiayCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, idSanpham, soLuong, mauSac, sizeName);
    }
